...
from routes import accounts_router, profiles_router, movie_router, cart_router, payment_router
...
app.include_router(payment_router, prefix=f"{api_version_prefix}/payment", tags=["payment"])
