...
Revision ID: e8d98e5b0ff6
Revises:
Create Date: 2025-02-04 12:00:13.774351
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("movie_id", "user_id", name="unique_movie_user_rating_constraint"),
    )
    op.create_table(
        "movies_directors",
        sa.Column("movie_id", sa.Integer(), nullable=False),
